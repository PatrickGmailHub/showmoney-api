ALTER TABLE pessoa ADD COLUMN logradouro VARCHAR(60) NOT NULL;
ALTER TABLE pessoa ADD COLUMN numero VARCHAR(10) NOT NULL;
ALTER TABLE pessoa ADD COLUMN complemento VARCHAR(60);
ALTER TABLE pessoa ADD COLUMN bairro VARCHAR(60) NOT NULL;
ALTER TABLE pessoa ADD COLUMN cep VARCHAR(60);
ALTER TABLE pessoa ADD COLUMN cidade VARCHAR(60) NOT NULL;
ALTER TABLE pessoa ADD COLUMN estado VARCHAR(60) NOT NULL;
